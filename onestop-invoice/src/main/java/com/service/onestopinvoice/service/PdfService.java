...
public class PdfService {
  ...
  public String WriteInvoice(InvoiceDTO invoiceDTO, GenerateInvoiceDTO generateInvoiceDTO) {
    ...
    try {
      ...
      cs.fill(); // Fill the rectangle with color

      // Load the image
      File file = new File("/home/bibhu04/Microservices/onestop/onestop-invoice/logo.png"); 
      ...
      String pdfFilePath = currentDirectory + "/invoice/" + invoiceDTO.getNameAndPhones().get(0).getName() + "_"
          + generateInvoiceDTO.getBillId() + ".pdf";

      // String pdfFilePath =
      // "/home/bibhu04/Microservices/onestop/onestop-invoice/invoice/customer_details.pdf";
